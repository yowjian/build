...
void ISRM::handleUpdateConfig(json j) {
    Utils::logElapsedTime(j, "ISRM", "updateConfig");
...
void ISRM::handleDetectionsRequest(json j) {
    Utils::logElapsedTime(j, "ISRM", "requestISRMDetections");
...
void ISRM::handleRecieveRDRDetections(json j) {
    Utils::logElapsedTime(j, "ISRM", "recieveRDRDetections");
...
void ISRM::handleRecieveEOIRDetections(json j) {
    Utils::logElapsedTime(j, "ISRM", "recieveEOIRDetections");
...
void ISRM::updateMissionPlan(const json &j) {
    Utils::logElapsedTime(j, "ISRM", "updateMissionPlan");
