...
void MPX::handleUpdateConfig(json j) {
    Utils::logElapsedTime(j, "MPX", "updateConfig");
...
void MPX::handleNewPlan(json j) {
    Utils::logElapsedTime(j, "MPX", "updateMissionPlan");
...
void MPX::recieveISRMDetections(json det) {
    Utils::logElapsedTime(det, "MPX", "recieveISRMDetections");
