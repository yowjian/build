; ModuleID = '/workspaces/build/apps/examples/example3/partitioned/multithreaded/purple/purple_rpc.c'
source_filename = "/workspaces/build/apps/examples/example3/partitioned/multithreaded/purple/purple_rpc.c"
...
@.str.1 = private unnamed_addr constant [87 x i8] c"/workspaces/build/apps/examples/example3/partitioned/multithreaded/purple/purple_rpc.c\00", section "llvm.metadata"
...
@llvm.global.annotations = appending global [2 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (double (i32*)* @_rpc_get_ewma to i8*), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([87 x i8], [87 x i8]* @.str.1, i32 0, i32 0), i32 18 }, { i8*, i8*, i8*, i32 } { i8* bitcast (double ()* @_err_handle_rpc_get_ewma to i8*), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([87 x i8], [87 x i8]* @.str.1, i32 0, i32 0), i32 164 }], section "llvm.metadata"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @_rpc_get_ewma(i32* %0) #0 !dbg !2 {
  ...
  call void @llvm.dbg.declare(metadata %struct._request_get_ewma_datatype* %5, metadata !66, metadata !DIExpression()), !dbg !87
  call void @llvm.dbg.declare(metadata %struct._response_get_ewma_datatype* %6, metadata !88, metadata !DIExpression()), !dbg !94
  call void @llvm.dbg.declare(metadata double* %7, metadata !95, metadata !DIExpression()), !dbg !96
  %11 = load i32, i32* @_rpc_get_ewma.inited, align 4, !dbg !97
  %12 = icmp ne i32 %11, 0, !dbg !97
  br i1 %12, label %23, label %13, !dbg !99

13:                                               ; preds = %1
  store i32 1, i32* @_rpc_get_ewma.inited, align 4, !dbg !100
  %14 = call i8* @xdc_pub_socket(), !dbg !102
  store i8* %14, i8** @_rpc_get_ewma.psocket, align 8, !dbg !103
  ...
  store i8* %21, i8** @_rpc_get_ewma.ssocket, align 8, !dbg !105
  %22 = call i32 @sleep(i32 1), !dbg !106
  br label %23, !dbg !107

23:                                               ; preds = %13, %1
  %24 = getelementptr inbounds %struct._request_get_ewma_datatype, %struct._request_get_ewma_datatype* %5, i32 0, i32 0, !dbg !108
  store i32 0, i32* %24, align 1, !dbg !109
  %25 = load i32, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !110
  %26 = getelementptr inbounds %struct._request_get_ewma_datatype, %struct._request_get_ewma_datatype* %5, i32 0, i32 1, !dbg !111
  ...
  %28 = load i32, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !114
...
30:                                               ; preds = %23
  ...
  store i32 5, i32* %9, align 4, !dbg !120
  br label %31, !dbg !121
...
34:                                               ; preds = %31
  %35 = load i8*, i8** @_rpc_get_ewma.psocket, align 8, !dbg !124
  %36 = bitcast %struct._request_get_ewma_datatype* %5 to i8*, !dbg !126
  call void @xdc_asyn_send(i8* %35, i8* %36, %struct._tag* %3), !dbg !127
  %37 = load i8*, i8** @_rpc_get_ewma.ssocket, align 8, !dbg !128
  %38 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !129
...
52:                                               ; preds = %48
  %53 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !149
  ...
  store i32 %57, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !153
  br label %58, !dbg !154
...
59:                                               ; preds = %58, %23
  %60 = getelementptr inbounds %struct._request_get_ewma_datatype, %struct._request_get_ewma_datatype* %5, i32 0, i32 0, !dbg !156
  store i32 0, i32* %60, align 1, !dbg !157
  %61 = load i32, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !158
  %62 = getelementptr inbounds %struct._request_get_ewma_datatype, %struct._request_get_ewma_datatype* %5, i32 0, i32 1, !dbg !159
  ...
  store i32 5, i32* %10, align 4, !dbg !163
  br label %64, !dbg !164
...
67:                                               ; preds = %64
  %68 = load i8*, i8** @_rpc_get_ewma.psocket, align 8, !dbg !167
  %69 = bitcast %struct._request_get_ewma_datatype* %5 to i8*, !dbg !169
  call void @xdc_asyn_send(i8* %68, i8* %69, %struct._tag* %3), !dbg !170
  %70 = load i8*, i8** @_rpc_get_ewma.ssocket, align 8, !dbg !171
  %71 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !172
...
81:                                               ; preds = %80, %64
  %82 = load i32, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !187
  %83 = add nsw i32 %82, 1, !dbg !187
  store i32 %83, i32* @_rpc_get_ewma.req_counter, align 4, !dbg !187
  %84 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !188
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @_err_handle_rpc_get_ewma() #0 !dbg !192 {
  ...
  %3 = call double @_rpc_get_ewma(i32* %1), !dbg !199
...
!10 = !DIFile(filename: "/workspaces/build/apps/examples/example3/partitioned/multithreaded/purple/purple_rpc.c", directory: "/workspaces/build/apps/examples/example3")
!11 = !{}
!12 = !{!13}
...
!47 = !DILocation(line: 18, column: 27, scope: !2)
...
!66 = !DILocalVariable(name: "request_get_ewma", scope: !2, file: !3, line: 45, type: !67)
!67 = !DIDerivedType(tag: DW_TAG_typedef, name: "request_get_ewma_datatype", file: !68, line: 75, baseType: !69)
!68 = !DIFile(filename: "partitioned/multithreaded/autogen/codec.h", directory: "/workspaces/build/apps/examples/example3")
!69 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_request_get_ewma_datatype", file: !68, line: 72, size: 160, elements: !70)
!70 = !{!71, !75}
...
!87 = !DILocation(line: 45, column: 31, scope: !2)
!88 = !DILocalVariable(name: "response_get_ewma", scope: !2, file: !3, line: 48, type: !89)
!89 = !DIDerivedType(tag: DW_TAG_typedef, name: "response_get_ewma_datatype", file: !68, line: 89, baseType: !90)
!90 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_response_get_ewma_datatype", file: !68, line: 86, size: 192, elements: !91)
!91 = !{!92, !93}
...
!94 = !DILocation(line: 48, column: 32, scope: !2)
...
!108 = !DILocation(line: 70, column: 22, scope: !2)
!109 = !DILocation(line: 70, column: 28, scope: !2)
!110 = !DILocation(line: 71, column: 36, scope: !2)
!111 = !DILocation(line: 71, column: 22, scope: !2)
!112 = !DILocation(line: 71, column: 30, scope: !2)
!113 = !DILocation(line: 71, column: 34, scope: !2)
...
!149 = !DILocation(line: 111, column: 63, scope: !145)
!150 = !DILocation(line: 111, column: 71, scope: !145)
!151 = !DILocation(line: 111, column: 75, scope: !145)
...
!157 = !DILocation(line: 117, column: 28, scope: !2)
