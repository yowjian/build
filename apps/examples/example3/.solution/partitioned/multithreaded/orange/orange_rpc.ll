; ModuleID = '/workspaces/build/apps/examples/example3/partitioned/multithreaded/orange/orange_rpc.c'
source_filename = "/workspaces/build/apps/examples/example3/partitioned/multithreaded/orange/orange_rpc.c"
...
@.str.1 = private unnamed_addr constant [87 x i8] c"/workspaces/build/apps/examples/example3/partitioned/multithreaded/orange/orange_rpc.c\00", section "llvm.metadata"
...
define dso_local void @_handle_request_get_ewma() #0 !dbg !2 {
  ...
  call void @llvm.dbg.declare(metadata %struct._request_get_ewma_datatype* %3, metadata !63, metadata !DIExpression()), !dbg !84
  call void @llvm.dbg.declare(metadata %struct._response_get_ewma_datatype* %4, metadata !85, metadata !DIExpression()), !dbg !91
  %8 = load i32, i32* @_handle_request_get_ewma.inited, align 4, !dbg !92
  %9 = icmp ne i32 %8, 0, !dbg !92
  br i1 %9, label %20, label %10, !dbg !94

10:                                               ; preds = %0
  store i32 1, i32* @_handle_request_get_ewma.inited, align 4, !dbg !95
  %11 = call i8* @xdc_pub_socket(), !dbg !97
  store i8* %11, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !98
  ...
  store i8* %18, i8** @_handle_request_get_ewma.ssocket, align 8, !dbg !100
...
24:                                               ; preds = %21
  %25 = load i8*, i8** @_handle_request_get_ewma.ssocket, align 8, !dbg !108
  %26 = bitcast %struct._request_get_ewma_datatype* %3 to i8*, !dbg !110
  ...
  %27 = getelementptr inbounds %struct._request_get_ewma_datatype, %struct._request_get_ewma_datatype* %3, i32 0, i32 1, !dbg !114
  ...
  %31 = load i32, i32* @_handle_request_get_ewma.res_counter, align 4, !dbg !118
...
33:                                               ; preds = %24
  ...
  store i32 %34, i32* @_handle_request_get_ewma.res_counter, align 4, !dbg !124
  %35 = call double @get_ewma(), !dbg !125
  store double %35, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !126
  %36 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !127
  %37 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %4, i32 0, i32 0, !dbg !128
  store double %36, double* %37, align 1, !dbg !129
  %38 = load i32, i32* %6, align 4, !dbg !130
  store i32 %38, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !131
  br label %39, !dbg !132

39:                                               ; preds = %33, %24
  %40 = load i32, i32* @_handle_request_get_ewma.res_counter, align 4, !dbg !133
  %41 = shl i32 %40, 2, !dbg !134
  %42 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !135
  %43 = shl i32 %42, 1, !dbg !136
  %44 = or i32 %41, %43, !dbg !137
  %45 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %4, i32 0, i32 1, !dbg !138
  ...
  %47 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !141
  %48 = bitcast %struct._response_get_ewma_datatype* %4 to i8*, !dbg !142
...
declare dso_local double @get_ewma() #2

declare dso_local void @xdc_asyn_send(i8*, i8*, %struct._tag*) #2

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_wrapper_request_get_ewma(i8* %0) #0 !dbg !147 {
  %2 = alloca i8*, align 8
...
3:                                                ; preds = %1, %3
  call void @_handle_request_get_ewma(), !dbg !152
...
define dso_local i32 @_slave_rpc_loop() #0 !dbg !155 {
  ...
  %4 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @_wrapper_request_get_ewma, i8* null) #5, !dbg !168
...
!3 = !DIFile(filename: "partitioned/multithreaded/orange/orange_rpc.c", directory: "/workspaces/build/apps/examples/example3")
...
!7 = !DIFile(filename: "/workspaces/build/apps/examples/example3/partitioned/multithreaded/orange/orange_rpc.c", directory: "/workspaces/build/apps/examples/example3")
!8 = !{}
!9 = !{!10, !12}
...
!65 = !DIFile(filename: "partitioned/multithreaded/autogen/codec.h", directory: "/workspaces/build/apps/examples/example3")
!66 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_request_get_ewma_datatype", file: !65, line: 72, size: 160, elements: !67)
!67 = !{!68, !72}
...
!84 = !DILocation(line: 45, column: 31, scope: !2)
!85 = !DILocalVariable(name: "response_get_ewma", scope: !2, file: !3, line: 48, type: !86)
!86 = !DIDerivedType(tag: DW_TAG_typedef, name: "response_get_ewma_datatype", file: !65, line: 89, baseType: !87)
!87 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_response_get_ewma_datatype", file: !65, line: 86, size: 192, elements: !88)
!88 = !{!89, !90}
...
!91 = !DILocation(line: 48, column: 32, scope: !2)
...
!115 = !DILocation(line: 95, column: 52, scope: !109)
...
!127 = !DILocation(line: 100, column: 37, scope: !122)
!128 = !DILocation(line: 100, column: 31, scope: !122)
!129 = !DILocation(line: 100, column: 35, scope: !122)
...
!133 = !DILocation(line: 104, column: 41, scope: !109)
!134 = !DILocation(line: 104, column: 53, scope: !109)
!135 = !DILocation(line: 104, column: 60, scope: !109)
!136 = !DILocation(line: 104, column: 81, scope: !109)
!137 = !DILocation(line: 104, column: 58, scope: !109)
!138 = !DILocation(line: 104, column: 27, scope: !109)
!139 = !DILocation(line: 104, column: 35, scope: !109)
!140 = !DILocation(line: 104, column: 39, scope: !109)
...
!147 = distinct !DISubprogram(name: "_wrapper_request_get_ewma", scope: !3, file: !3, line: 113, type: !148, scopeLine: 113, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !8)
