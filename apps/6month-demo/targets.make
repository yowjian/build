...
ORANGE_LDFLAGS=-L${ORANGE_HAL}/arm64_prebuild $(AARCH64_LDFLAGS) -L${ORANGE_HAL}/api -L${ORANGE_HAL}/appgen/6month-demo $(HAL_LIBS) -lzmq -lstdc++ -lc -lpthread -dl -llzma -lsodium -lunwind -ldl
endif
...
GREEN_LDFLAGS=-L${GREEN_HAL}/arm64_prebuild $(AARCH64_LDFLAGS) -L${GREEN_HAL}/api -L${GREEN_HAL}/appgen/6month-demo $(HAL_LIBS) -lzmq -lstdc++ -lc -lpthread -dl -llzma -lsodium -lunwind -ldl
endif
